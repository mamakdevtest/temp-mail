...
export default function AddressBar({
  ...
  const handleCustomSubmit = (e) => {
    ...
    onCustomCreate(customUsername, customDomain);
    setShowCustom(false);
    setCustomUsername('');
  };
      ...
      {currentAddress ? (
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1 min-w-0">
              <p className="text-sm text-gray-500 mb-1">Geçici e-posta adresiniz:</p>
          ...
          <div className="border-t pt-4">
            ...
            {showCustom && (
              <form onSubmit={handleCustomSubmit} className="mt-3 flex flex-col sm:flex-row gap-3">
                <input
                  type="text"
        ...
        <div className="text-center py-8 space-y-4">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            ...
            Adres {currentAddress?.ttl_minutes || 60} dakika sonra otomatik silinir.
          </p>
